...
--a0 "$LP/Input_data/Chromatin_final_df.csv"  --a1 "$LP/Input_data/Discarded_sample_list_for_Chromatin.txt" \
--a2 300 --a3 10000 \
--o1 "$LP/Output_data/Chromatin_bootstrapping_result_KT_summary" \
